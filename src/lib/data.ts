...
export const doctors: Doctor[] = [
  { id: "doc1", name: "Dr. Priya Sharma", department: "Cardiology", availability: ["Monday 9-12", "Wednesday 14-17"], rating: 4.8, experience: 12 },
  { id: "doc2", name: "Dr. Rohan Gupta", department: "Neurology", availability: ["Tuesday 10-13", "Thursday 15-18"], rating: 4.9, experience: 15 },
  { id: "doc3", name: "Dr. Ananya Reddy", department: "Pediatrics", availability: ["Friday 8-11"], rating: 4.7, experience: 8 },
  { id: "doc4", name: "Dr. Vikram Singh", department: "Orthopedics", availability: ["Monday 13-16", "Wednesday 9-12"], rating: 4.6, experience: 10 },
  { id: "doc5", name: "Dr. Sunita Patel", department: "General", availability: ["Tuesday 14-17", "Thursday 10-13"], rating: 4.8, experience: 7 },
];
